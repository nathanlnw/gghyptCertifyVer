...
#define       DF_PhoneBook_Page                        5300//1440    (>20条)                       // Block 起始- 电话本相关
#define       DF_CircleRail_Page                       1448                           // Block 起始- 圆形围栏

#define       DF_RectangleRail_Page                    5340                           // Block 起始- 矩形围栏  1288  --过检验就用7000 了 24个 
...
//#define  DF_Record_Page                         7936  // 再测试完行车记录仪前没用
