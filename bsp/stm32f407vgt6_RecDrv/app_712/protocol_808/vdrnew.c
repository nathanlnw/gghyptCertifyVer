...
#define VDR_10H_START	0x330000
#define VDR_10H_END		0x337FFF

#define VDR_11H_START	0x338000
#define VDR_11H_END		0x339FFF

#define VDR_12H_START	0x33A000
#define VDR_12H_END		0x33BFFF

#define VDR_13H_START	0x33C000
#define VDR_13H_END		0x33CFFF

#define VDR_14H_START	0x33D000
#define VDR_14H_END		0x33DFFF

#define VDR_15H_START	0x33E000
#define VDR_15H_END		0x33EFFF
...
{
	static uint8_t	month_09 = 4, day_09 = 30, hour_09 = 23;
	...
	*p++	= HEX_TO_BCD( 0 );          /*sec*/
	...
	for( i = addr_09; i < addr_09 + ( 60 * 128 ); i += 128 )
	{
		SST25V_BufferRead( buf, i, 128 );
		decompress_data( buf, data );
		for( j = 0; j < 60; j++ )
